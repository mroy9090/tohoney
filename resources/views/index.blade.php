            ...
            <div class="swiper-wrapper">
                @foreach ($slider as $slider_data)
                    <div class="swiper-slide overlay">
                        <div class="single-slider slide-inner" style="background: url({{ asset('images/slider_image/'.$slider_data->slider_photo) }})">
                            <div class="container">
                                <div class="row">
                                    <div class="col-lg-12 col-lg-9 col-12">
                                        <div class="slider-content">
                                            <div class="slider-shape">
                                                <h2 data-swiper-parallax="-500">{{ $slider_data->slider_title }}</h2>
                                                <p data-swiper-parallax="-400">{{ $slider_data->slider_short_description }}</p>
                    ...
                    <div class="featured-active2 owl-carousel next-prev-style">
                        ...
                        <div class="featured-wrap">
                            <div class="featured-img">
                                <img src="{{ asset('images/category_image/'.$category_name->category_image) }}" alt="not found">
                                <div class="featured-content">
                                    <a href="{{ route('singleShop',[$category_name->id]) }}">{{ $category_name->category_name  }}</a>
                                </div>
                            </div>
                        </div>
                        @endforeach
            ...
            <div class="row">
                <div class="col-12">
                    <div class="section-title">
                        <h2>Best Seller</h2>
                        <img src="{{ asset('tohoney') }}/assets/images/section-title.png" alt="">
                    </div>
                </div>
            </div>
            <ul class="row">
                <li class="col-xl-3 col-lg-4 col-sm-6 col-12">
                    <div class="product-wrap">
                        <div class="product-img">
                            <img src="{{ asset('tohoney') }}/assets/images/product/1.jpg" alt="">
                ...
                <li class="col-xl-3 col-lg-4 col-sm-6 col-12">
                    <div class="product-wrap">
                        <div class="product-img">
                            <img src="{{ asset('tohoney') }}/assets/images/product/2.jpg" alt="">
                            <div class="product-icon flex-style">
                                <ul>
                                    <li><a data-toggle="modal" data-target="#exampleModalCenter" href="javascript:void(0);"><i class="fa fa-eye"></i></a></li>
                                    <li><a href="wishlist.html"><i class="fa fa-heart"></i></a></li>
                ...
                <li class="col-xl-3 col-lg-4 col-sm-6 col-12">
                    <div class="product-wrap">
                        <div class="product-img">
                            <img src="{{ asset('tohoney') }}/assets/images/product/3.jpg" alt="">
                            <div class="product-icon flex-style">
                                <ul>
                                    <li><a data-toggle="modal" data-target="#exampleModalCenter" href="javascript:void(0);"><i class="fa fa-eye"></i></a></li>
                                    <li><a href="wishlist.html"><i class="fa fa-heart"></i></a></li>
                ...
                <li class="col-xl-3 col-lg-4 col-sm-6 col-12">
                    <div class="product-wrap">
                        <div class="product-img">
                            <img src="{{ asset('tohoney') }}/assets/images/product/4.jpg" alt="">
                            <div class="product-icon flex-style">
                                <ul>
                                    <li><a data-toggle="modal" data-target="#exampleModalCenter" href="javascript:void(0);"><i class="fa fa-eye"></i></a></li>
                                    <li><a href="wishlist.html"><i class="fa fa-heart"></i></a></li>
                        ...
                        @foreach ($testimonial as $testimonial)
                            <div class="test-items test-items2">
                                <div class="test-content">
                                    <p>{{ $testimonial->customer_details }}</p>
                                    <h2>{{ $testimonial->customer_name }}</h2>
                                    <p>{{ $testimonial->customer_position }}</p>
                                </div>
                                <div class="test-img2">
                                    <img src="{{ asset('images/testimonial_image/'.$testimonial->customer_photo) }}" alt="not found">
                                </div>
                            </div>
